...
public class RedisConfig {
    ...
    @Bean
    RedisTemplate<String, List<ReviewEntity>> redisTemplate(RedisConnectionFactory factory) {
        RedisTemplate<String, List<ReviewEntity>> template = new RedisTemplate<>();
    ...
    @Bean
    ValueOperations<String, List<ReviewEntity>> valueOps(RedisTemplate<String, List<ReviewEntity>> redisTemplate) {
