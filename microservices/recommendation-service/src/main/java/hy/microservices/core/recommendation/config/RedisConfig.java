...
public class RedisConfig {
    ...
    @Bean
    RedisTemplate<String, List<RecommendationEntity>> redisTemplate(RedisConnectionFactory factory) {
        RedisTemplate<String, List<RecommendationEntity>> template = new RedisTemplate<>();
    ...
    @Bean
    ValueOperations<String, List<RecommendationEntity>> valueOps(RedisTemplate<String, List<RecommendationEntity>> redisTemplate) {
